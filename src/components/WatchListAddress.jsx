    ...
    return (
        ...
        <li className={WatchListCSS.address}>
            ...
            <div className={WatchListCSS.addressOptions}>
                {address.alerts ? <FaVolumeUp color='#00ac31' role="button" onClick={() => handleChangeAlert(address.id)}/> 
                : <FaVolumeMute color='red' role="button" onClick={() => handleChangeAlert(address.id)}/>}
                ...
                {address.website && (address.website.includes("https://") ? <a target="_blank" href={address.website}><FaGlobe color='#dda624'/></a>
                : <a target="_blank" href={`https://${address.website}`}><FaGlobe color='#dda624'/></a>)}
