    ...
    <main>
      ...
      <div id={HomeCSS.featuresRow}>
        <div className={HomeCSS.feature}>
          ...
          <p>
            Add addresses you want to watch to see their activity on your feed.
          </p>
        </div>
        <div className={HomeCSS.feature}>
          <div className={HomeCSS.featureImg}>
          ...
          <p>
            Track transactions from addresses on your wacthlist and get instant
            notifications.
          </p>
        </div>
        <div className={HomeCSS.feature}>
      ...
      <h3 className={HomeCSS.landingText}>
        ...
        receive alerts directly to your browser! No more unnanounced dumps from
        3AC or Alameda wallets! Start by connecting your wallet so you can start
        adding addresses to your watch list to populate your feed. Wanna talk to
        the other on-chain checkoors? Check out the trollbox. Need something to
        keep you busy while you wait for alerts? Have fun trying old-school
        games in the Dosbox.
      </h3>
      <iframe
